...
********************************************************************************
**** What's New? (Version 2.4.8, 5.12.2010) 
********************************************************************************
...
********************************************************************************
**** What's New? (Version 2.4.7, 5.7.2010) 
********************************************************************************
...
********************************************************************************
**** Integration Changes (Version 2.4.7, 5.7.2010)
********************************************************************************
- This version does not support using a base SDK older than 3.0. You may still use a deployment target as low as 2.0
- For games that require a base SDK of 2.2.1 or older, use OpenFeint 2.4.5
- This version requires xcode 3.2. For older versions of xcode use OpenFeint 2.4.5.


**** Changes from 2.4.5 to 2.4.6 are listed below:
- There is a new iPad resource folder. If your game does not support iPad you can remove it.
...
**** Changes from 2.3 to 2.4 are listed below:
...
5. Remove unused asset folders. This is not a necessary step but helps cut down the application size. You need to do this every time you download a new OpenFeint project.
